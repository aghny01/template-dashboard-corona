...
@section('content')
                    ...
                    <div class="left-text-content">
                        ...
                        @if ($about->count() === 0)
                            ...
                            @else
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <img src="{{ asset("about-images/$item->img") }}" alt="" style="width: 100%;">
                                    </div>
                                </div>
                                @endforeach
                            @endif
                ...
                <div class="owl-menu-item owl-carousel">
                    ...
                    @else
                        @foreach ($menu as $item)         
                                    <div class="item">
                                        <div class='card card-baru' style="background-image: url({{ asset("menu-images/$item->img") }});">
                                            <div class="price"><h6>Rp{{ $item->harga }}</h6></div>
                                            <div class='info'>
            ...
            <div class="col-lg-4">
                <div class="chef-item">
                    <div class="thumb">
                        <div class="overlay"></div>
                        <ul class="social-icons">
                            <li><a href="{{ 'https://www.instagram.com/' . $item->instagram }}"><i class="fa fa-instagram"></i></a></li>
                        </ul>
                        <img src="{{ asset("chef-images/$item->img") }}" alt="Chef #3">
                    </div>
                    <div class="down-content">
                        <h4>{{ $item->name }}</h4>
    ...
    <section class="section" id="reservation" style="margin-bottom: -60px;">
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">0815-7374-9857</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">Aghny@company.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ url('reservasi') }}" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="no_meja" name="no_meja" id="no_meja">
                            ...
                            <div class="col-lg-6">
                                <div id="filterDate2">    
                                  <div class="input-group datetimepicker" >
                                    <input  name="date" id="date" type="date" class="form-control" placeholder="Date & Time">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="orang" name="orang" id="orang">
                                    <option value="Jumlah orang">Jumlah Orang</option>
                                    <option name="1" id="1">1</option>
                                    <option name="2" id="2">2</option>
                                    <option name="3" id="3">3</option>
                                    <option name="4" id="4">4</option>
